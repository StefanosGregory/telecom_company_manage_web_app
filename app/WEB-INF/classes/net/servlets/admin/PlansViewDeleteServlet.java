...
@WebServlet("/PlansViewDeleteServlet")
public class PlansViewDeleteServlet extends HttpServlet { 
	private static final long serialVersionUID = 1L;
	PlanDeleteDao planDeleteDao;
    public void init() {
    	planDeleteDao = new PlanDeleteDao();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("username",username);
	       ...
	       response.setCharacterEncoding("UTF-8");
	        ...
	        out.print("<title>Delete Plan</title>");
	        out.print("</head>");
	        out.print("<body>");
	        out.print("<ul>");
	        ...
	        out.print("      <a class='edit'>Delete</a>");
	        out.print("    </div>");
	        out.print("  </li>");
	        out.print("<li>"); 
	        ...
	        out.print("</ul>");
	          ...
	          List<PlanBean> list = planDeleteDao.getAllPlans();  
	          ...
	          for(PlanBean e:list) {
	          	out.print("<tr><td class='center'>"+e.getPlan()+"</td><td>"+e.getSms()+"</td><td>"+e.getData()+"</td><td class='center'>"+e.getAirTime()+"</td><td class='center'>"+e.getPrice()+" €"+"</td><td class='center'><a class='center' href='PlanDeleteServlet?id="+e.getPlan()+"'> <img class='image' src='icons/trush.png'></a></td></tr>");
	          }
	          out.print("</table>");
	          out.print("<br>");
	          out.print("</div>");
