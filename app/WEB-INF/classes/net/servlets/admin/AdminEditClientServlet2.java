 ...
 */
@WebServlet("/AdminEditClientServlet2")
public class AdminEditClientServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("username",username1);
		  response.setContentType("text/html");  
	        ...
	        if(status>0){  
	            response.sendRedirect("AdminClientsViewServlet");  
	        }else{  
	        	out.print("<div class='alert'>");
	  	        out.print("<form action='AdminClientsViewServlet'>Error, try again later!<input type='submit' class='closebtn' value='X'/></form>");  
	        	out.print("</div>");
	        }  
