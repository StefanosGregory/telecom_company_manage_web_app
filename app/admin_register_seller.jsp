...
<html>
<head>
  <link rel="stylesheet" type="text/css" href="css/admin_register_seller.css">
...
<br>
  ...
  <form action="<%=request.getContextPath()%>/AdminRegisterSellerServlet" method="post" class="form1">
    <div class="container">
      <h1 class="register">Register a Seller, </h1>
